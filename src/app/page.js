...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <div className="flex flex-col items-center justify-center  text-center md:max-w-3/4 m-auto bg-white/30 backdrop-blur-lg rounded-4xl mt-50 p-4">
        ...
        <a
          href="/about"
          className="flex flex-row justify-between items-center text-blue-500 underline mt-4 text-lg"
        >
          About <img src="/right-up.svg" alt="arrow to go to about page" />
        </a>
      </div>
    </div>
  );
